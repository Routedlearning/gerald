...
```
/root/projects/gerald/modules/fitness/
├── __pycache__/
...
Cron (0 5 * * 1-6)
  └── cronjob `02c87d1e02bf`
       └── prompt: run /root/projects/gerald/modules/fitness/scripts/cron_dispatch.sh 2026-06-29
            └── cron_dispatch.sh
                 ├── cd /root/projects/gerald/modules/fitness
...
- `/root/projects/gerald/modules/fitness/scripts/cron_dispatch.sh`
...
- Backups stored in `/root/projects/gerald/modules/fitness/backups/`
...
**Manual backup:**
```bash
/root/projects/gerald/modules/fitness/scripts/backup_workout_history.sh
```
...
/root/projects/gerald/modules/fitness/scripts/restore_workout_history.sh <filename>
```
